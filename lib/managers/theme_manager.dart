...
class ThemeManager {
  ...
  static Color getCardColor({Color? lightColor, Color? darkColor}) {
    return _isDarkMode
        ? (darkColor ?? const Color(0xFF1F1F1F))
  ...
  static Color getCalendarSelectedColor() {
    return _isDarkMode
        ? Colors.blue[600]!
        : const Color.fromARGB(200, 68, 138, 218);
  }
  ...
  static Color getCalendarHolidayColor() {
    return _isDarkMode
        ? const Color.fromARGB(255, 80, 40, 40)
  ...
  static Color getNavigationBarColor() {
    return _isDarkMode
        ...
        : const Color.fromARGB(255, 162, 222, 141);
  }
  ...
  static Color getCalendarDayOfWeekBackgroundColor() {
    return _isDarkMode
        ...
        : const Color(0xFFEEEEEE); // 요일 헤더 배경
  }
  ...
  static Color getCalendarCellBackgroundColor({
    ...
    if (isSelected) {
      ...
      return _isDarkMode
          ...
          : const Color.fromARGB(
            ...
            255,
            255,
          ); //_HE_평일과 같은 컬러로 설정. 필요시 별도 설정 가능.
    }
    return _isDarkMode ? const Color(0xFF1E1E1E) : Colors.white; // 기본 날짜 셀 배경
  }

  static Color getCalendarCellDateColor({
    bool isSelected = false,
    bool isHoliday = false,
  ...
  static Color getEventPopupMaterialBackgroundColor() =>
      getPopupSecondaryBackgroundColor();
  static Color getEventPopupFilterChipBackgroundColor() =>
      getPopupSecondaryBackgroundColor();
  static Color getEventPopupCounterBackgroundColor() =>
      getPopupSecondaryBackgroundColor();

  // 모든 보조 텍스트 (힌트, 아이콘 등)
  static Color getEventPopupHintTextColor() => getPopupSecondaryTextColor();
  static Color getEventPopupSecondaryTextColor() =>
      getPopupSecondaryTextColor();
  ...
  static Color getEventPopupOutlinedButtonBorderColor() =>
      getPopupBorderColor();

  // TimePicker는 기본 테마 색상 사용
  static Color getEventPopupTimePickerBackgroundColor() =>
      getPopupBackgroundColor();
  static Color getEventPopupTimePickerTextColor() => getTextColor();
  static Color getEventPopupTimePickerDayPeriodColor() =>
      getPopupSecondaryBackgroundColor();
  ...
  static Color getAddEventButtonColor() {
    return _isDarkMode
        ? const Color.fromARGB(255, 120, 180, 120)
        : const Color.fromARGB(255, 162, 222, 141);
  }

  static Color getAddMultiDayEventButtonColor() {
    return _isDarkMode
        ? const Color.fromARGB(255, 80, 120, 150)
        : const Color.fromARGB(255, 101, 157, 189);
  }

  // 채팅 전용 색상들
  static Color getChatInputBackgroundColor() {
    return _isDarkMode
        ? const Color.fromARGB(122, 58, 58, 58)
        : const Color.fromARGB(31, 58, 58, 58); // 어두운 회색
  }

  static Color getChatMessageBackgroundColor() {
    return _isDarkMode
        ? const Color.fromARGB(255, 41, 41, 41)
        : Colors.grey[100]!; // 어두운 회색
  }
  ...
  static Color getChatSentMessageBackgroundColor() {
    return _isDarkMode
        ? const Color.fromARGB(255, 52, 112, 67)
        : const Color.fromARGB(255, 33, 150, 243); // 보낸 메시지
  }
  ...
  static Color getInfoBoxBackgroundColor() {
    return _isDarkMode
        ...
        : Colors.blue[50]!; // 다크모드: 어두운 청색, 라이트모드: 밝은 청색
  }

  static Color getInfoBoxBorderColor() {
    return _isDarkMode
        ? const Color(0xFF4A6A7A)
        : Colors.blue[200]!; // 다크모드: 중간 청색, 라이트모드: 중간 청색
  }

  static Color getInfoBoxIconColor() {
    return _isDarkMode
        ? Colors.blue[300]!
        : Colors.blue[600]!; // 다크모드: 밝은 청색, 라이트모드: 어두운 청색
  }

  static Color getInfoBoxTextColor() {
    return _isDarkMode
        ? Colors.blue[200]!
        : Colors.blue[700]!; // 다크모드: 밝은 청색, 라이트모드: 어두운 청색
  }
