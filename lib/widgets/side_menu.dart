  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      child: Drawer(
        ...
        //☑️테마에 따른 배경색 변경
        backgroundColor:
            ThemeManager.getSidebarBackgroundColor(), // ☑️ 사이드바 전용 배경색 사용
        child: Column(
          children: [
            Container(
            ...
            ListTile(
              ...
              subtitle: Text(
                ...
                style: getTextStyle(
                  fontSize: 10,
                  color:
                      ThemeManager.getPopupSecondaryTextColor(), // ☑️ 다크 모드 색상 적용
                ),
              ),
              onTap: () {
                Navigator.pop(context);
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          ...
                          color:
                              ThemeManager.getPopupBorderColor(), // ☑️ _HE_250620_변경
                          width: 0.5,
                        ),
                      ),
                      child: Center(
            ...
            ListTile(
              ...
              title: Text('다크 모드', style: getThemeTextStyle(fontSize: 12)),
              trailing: Switch(
            ...
            ListTile(
              ...
              subtitle: Text(
                ...
                style: getTextStyle(
                  ...
                  // color: Colors.grey
                  color:
                      ThemeManager.getPopupSecondaryTextColor(), // ☑️ _HE_250620_변경
                ),
              ),
              onTap: () {
                Navigator.pop(context);
        ...
        widget.events.where((event) {
          ...
          if (event.category != null && event.category == category) {
            ...
            if (event.colorId != null &&
                colorIdToCategory[event.colorId] == category) {
              isMatchingCategory = true;
            }
          }
          ...
          if (event.isMultiDay) {
            ...
            isCurrentMonth =
                (startDate.year == widget.currentMonth.year &&
                    startDate.month == widget.currentMonth.month) ||
                (endDate.year == widget.currentMonth.year &&
                    endDate.month == widget.currentMonth.month) ||
                (startDate.isBefore(firstDayOfMonth) &&
                    endDate.isAfter(lastDayOfMonth));
          } else {
            // 단일날짜 이벤트의 경우
            isCurrentMonth =
                event.date.year == widget.currentMonth.year &&
                event.date.month == widget.currentMonth.month;
          }
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(
                            ...
                            color:
                                ThemeManager.getPopupSecondaryTextColor(), // ☑️ 다크 모드 아이콘 색상 적용
                          ),
                          ...
                          Text(
                            ...
                            style: getTextStyle(
                              fontSize: 12,
                              color:
                                  ThemeManager.getPopupSecondaryTextColor(), // ☑️ 다크 모드 텍스트 색상 적용
                            ),
                            textAlign: TextAlign.center,
                          ),
                        ],
                    ...
                    : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          // ☑️ 다크 모드 카드 색상 적용
                          color:
                              ThemeManager.getPopupSecondaryBackgroundColor(),
                          elevation: 2,
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8),
                            side: BorderSide(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              ...
                              style: getTextStyle(
                                fontSize: 12,
                                color:
                                    ThemeManager.getTextColor(), // ☑️ 다크 모드 텍스트 색상 적용
                              ),
                            ),
                            subtitle: Column(
